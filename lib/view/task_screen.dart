...
class _TaskFormState extends State<TaskForm> {
  ...
  void initState() {
    super.initState();
    // Set the due date and priority to the existing task's values if available
    if (widget.task != null) {
      _dueDate = widget.task!.dueDate;
      _priority = _getPriorityLabel(widget.task!.priority);
    }
  }
  ...
  // Helper function to map priority label to value
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      final task = Task(
                        ...
                        description: _description,
                        priority:
                            _getPriorityValue(_priority), // Map label to value
                        dueDate: _dueDate,
                      );
                      if (widget.task == null) {
                        Provider.of<TaskProvider>(context, listen: false)
